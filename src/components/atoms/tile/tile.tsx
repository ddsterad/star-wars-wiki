...
const TileComponent: React.FC<TileProps> = ({type, content, setDetailInfo}) => {
    ...
    const filmTile = (
        <div className="tile-wrapper">
            ...
            <Button size="md" variant="soft" color="success" onClick={() => handleDetailClick("/film-detail-page") }>Info</Button>
        </div>
    )
    const vehicleTile = (
        <div className="tile-wrapper">
            ...
            <Button size="md" variant="soft" color="success" onClick={() => handleDetailClick("/vehicle-detail-page")}>Info</Button>
        </div>
    )
    const starshipsTile = (
        <div className="tile-wrapper">
            ...
            <div className='tile-label'>{content.model}</div>
            <div className='tile-label'>{content.name}</div>
            <Button size="md" variant="soft" color="success" onClick={() => handleDetailClick("/starships-detail-page")}>Info</Button>
        </div>
    )
    const speciesTile = (
        <div className="tile-wrapper">
            ...
            <Button size="md" variant="soft" color="success" onClick={() => handleDetailClick("/species-detail-page")}>Info</Button>
        </div>
    )
    const planetTile = (
        <div className="tile-wrapper">
            ...
            <Button size="md" variant="soft" color="success" onClick={() => handleDetailClick("/planet-detail-page")}>Info</Button>
        </div>
    )
    const peopleTile = (
        <div className="tile-wrapper">
            ...
            <div className='tile-label'>{content.name}</div>
            <Button size="md" variant="soft" color="success" onClick={() => handleDetailClick("/people-detail-page")}>Info</Button>
        </div>
    )
    return (
        <>
